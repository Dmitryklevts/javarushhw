public class Operators {
    public static void main(String[] args) {
        ...
        //TODO:
        // Виды операторов: Унарные (++j, j++, +6, -6, (int), !)
        // Арифметические(+ , - , *, / , %)
        // Cравнения (==, !=, > , >= , < , <=)
        // Логические (&& AND, || OR),
        // Побитовые (& bitwise AND, | bitwise OR, ^ bitwise eXclusive OR XOR)
        // Тернарные (1 > 2 ? 5 : 4)
        // Операторы составного присваивания (+=, -=, *=, /=, %=)

        int am =  4 > 3 ? 6 : 4; // if 4>3 a = 6 , else a = 4
        System.out.println(am);

        int x = 4;
        String s = x % 2 == 0 ? "Четное число" : "Нечетное число";
...
*/
        ...
        System.out.println(x++);// 4. Здесь x Все еще 4 и его инкремент отобразится уже в следующем шаге, т.к. происходит вывод справа-налево
        System.out.println(x);  // 5

        int y=4;
        y--;
        System.out.println(y);  // 3
        System.out.println(--y);// 2. Здесь y сразу отображается как 2
        ...
        */
        ...
        int z = (int)3.45; //Cast operator (int)
        System.out.println( "z is " + z);  // 3
